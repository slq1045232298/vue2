      ...
      <div class="container">
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul> 
                <li :class="{check:checkIndex == index}" @click="checkIndex = index;selectedAddrId=item.addressId" v-for="(item,index) in addressListFilter" :key="index">
                  <dl>
                    <dt>{{item.userName}}</dt>
                  ...
                  <div class="addr-opration addr-del">
                    <a @click="delAddressConfirm(item.addressId)" href="javascript:;" class="addr-del-btn">
                  ...
                  <div class="addr-opration addr-set-default">
                    <a @click="setDefault(item.addressId)" v-if="!item.isDefault" href="javascript:;" class="addr-set-default-btn">
                      <i>Set default</i>
                    </a>
                  </div>
            ...
            <div class="shipping-addr-more">
              <a @click="expand" :class="{open:limit>3}" class="addr-more-btn up-down-btn" href="javascript:;">
                more
                <i class="i-up-down">
